...
badd +72 stack.cpp
badd +0 stack.h
badd +0 teststack.cpp
badd +40 queue.cpp
badd +0 rover.h
badd +35 queue.h
badd +26 testqueue.cpp
badd +1 resultdata.h
badd +36 resultdata.cpp
badd +0 makefile
badd +1 instructions.txt
badd +34 rovercontrol.cpp
badd +34 rover.cpp
badd +14 scandata.h
badd +74 scandata.cpp
argglobal
silent! argdel *
$argadd stack.cpp
set stal=2
edit rovercontrol.cpp
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 59 - ((34 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
...
wincmd w
argglobal
if bufexists('resultdata.h') | buffer resultdata.h | else | edit resultdata.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 20 - ((4 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
20
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 49 - ((48 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 40 - ((25 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 83 - ((2 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
83
