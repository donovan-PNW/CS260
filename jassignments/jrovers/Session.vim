...
set shortmess=aoO
badd +1 design_questions.txt
badd +51 design_answers.txt
badd +0 instructions.txt
badd +0 rubric.txt
badd +1 teststack.cpp
badd +0 stack.h
badd +0 testqueue.cpp
argglobal
silent! argdel *
$argadd design_questions.txt
set stal=2
edit design_answers.txt
...
silent! normal! zE
let s:l = 28 - ((19 * winheight(0) + 26) / 53)
...
wincmd w
argglobal
if bufexists('design_questions.txt') | buffer design_questions.txt | else | edit design_questions.txt | endif
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 61 - ((32 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
