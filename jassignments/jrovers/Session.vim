...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/gruvbox/,~/.vim/plugged/badwolf/,~/.vim/plugged/vim-airline/,~/.vim/plugged/vim-airline-themes/,~/.vim/plugged/seoul256.vim/,~/.vim/plugged/vim-easy-align/,~/.vim/plugged/vim-github-dashboard/,~/.vim/plugged/vim-surround/,~/.vim/plugged/vim-repeat/,~/.vim/plugged/vim-easymotion/,~/.vim/plugged/indentline/,~/.vim/plugged/fzf/,~/.vim/plugged/VimCompletesMe/,~/.vim/plugged/undotree/,~/.vim/plugged/vim-multiple-cursors/,~/.vim/plugged/ale/,~/.vim/plugged/goyo.vim/,~/.vim/plugged/tcomment_vim/,~/.vim/plugged/vim-commentary/,~/.vim/plugged/jellybeans.vim/,~/.vim/plugged/vim-minimap/,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/plugged/indentline/after,~/.vim/after
set shiftwidth=4
set showcmd
...
silent only
cd ~/jCS260/jassignments/jrovers
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +22 design_questions.txt
badd +28 design_answers.txt
badd +37 instructions.txt
badd +34 rubric.txt
badd +1 teststack.cpp
badd +1 stack.h
badd +1 testqueue.cpp
badd +1 rovercontrol.cpp
badd +1 rover.h
badd +16 scandata.h
badd +69 scandata.cpp
badd +19 resultdata.h
badd +14 somequestions.txt
badd +401 expected.txt
badd +2 stack.cpp
badd +56 ../../examples/linkedListADT/linkedlist.cpp
badd +1 ../../examples/linkedListADT/list.h
badd +16 queue.h
badd +3 resultdata.cpp
argglobal
silent! argdel *
$argadd design_questions.txt
set stal=2
...
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F9> :exec '!python3' shellescape(@%, 1)
let &cpo=s:cpo_save
unlet s:cpo_save
setlocal keymap=
setlocal noarabic
...
silent! normal! zE
let s:l = 115 - ((34 * winheight(0) + 26) / 52)
...
wincmd w
argglobal
if bufexists('rubric.txt') | buffer rubric.txt | else | edit rubric.txt | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('somequestions.txt') | buffer somequestions.txt | else | edit somequestions.txt | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('teststack.cpp') | buffer teststack.cpp | else | edit teststack.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('rovercontrol.cpp') | buffer rovercontrol.cpp | else | edit rovercontrol.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F9> :exec '!python3' shellescape(@%, 1)
let &cpo=s:cpo_save
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 74 - ((40 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
74
...
wincmd w
argglobal
if bufexists('rover.h') | buffer rover.h | else | edit rover.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('stack.h') | buffer stack.h | else | edit stack.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe '2resize ' . ((&lines * 15 + 27) / 55)
exe 'vert 2resize ' . ((&columns * 103 + 106) / 212)
exe '3resize ' . ((&lines * 40 + 27) / 55)
exe 'vert 3resize ' . ((&columns * 108 + 106) / 212)
exe '4resize ' . ((&lines * 11 + 27) / 55)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 36 - ((26 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
...
wincmd w
argglobal
if bufexists('../../examples/linkedListADT/linkedlist.cpp') | buffer ../../examples/linkedListADT/linkedlist.cpp | else | edit ../../examples/linkedListADT/linkedlist.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F9> :exec '!python3' shellescape(@%, 1)
let &cpo=s:cpo_save
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 100 - ((0 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
100
...
wincmd w
argglobal
if bufexists('../../examples/linkedListADT/list.h') | buffer ../../examples/linkedListADT/list.h | else | edit ../../examples/linkedListADT/list.h | endif
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F9> :exec '!python3' shellescape(@%, 1)
let &cpo=s:cpo_save
...
exe 'vert 2resize ' . ((&columns * 120 + 106) / 212)
exe 'vert 3resize ' . ((&columns * 20 + 106) / 212)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
if bufexists('instructions.txt') | buffer instructions.txt | else | edit instructions.txt | endif
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F9> :exec '!python3' shellescape(@%, 1)
let &cpo=s:cpo_save
...
wincmd w
argglobal
if bufexists('resultdata.cpp') | buffer resultdata.cpp | else | edit resultdata.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('stack.cpp') | buffer stack.cpp | else | edit stack.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
