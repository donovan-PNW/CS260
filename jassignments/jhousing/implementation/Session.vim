...
silent only
cd ~/jCS260/jassignments/jhousing/implementation
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 hashtable.cpp
badd +0 familymgr.cpp
badd +102 testhashtable.cpp
argglobal
silent! argdel *
$argadd hashtable.cpp
edit familymgr.cpp
...
silent! normal! zE
let s:l = 68 - ((33 * winheight(0) + 26) / 53)
...
wincmd w
argglobal
if bufexists('hashtable.cpp') | buffer hashtable.cpp | else | edit hashtable.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F9> :exec '!python3' shellescape(@%, 1)
let &cpo=s:cpo_save
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 160 - ((35 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
160
