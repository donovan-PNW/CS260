...
int main()
{
    ...
    //    delete familyPtr;
    //    familyPtr = new family("Arevalo001", "dusty", 1);
    //    familyPtr->addFriend("Jerry");
    //    ht.addFamily(0, familyPtr);
    //    delete familyPtr;
    //    familyPtr = new family("Mosher002", "dusty", 1);
    //    familyPtr->addFriend("Jerry");
    //    ht.addFamily(0, familyPtr);
    //    delete familyPtr;
    //    familyPtr = new family("LEANNA", "Dusty", 1);
    //    familyPtr->addFriend("JERRY");
    //    ht.addFamily(0, familyPtr);
    //    delete familyPtr;
    //    familyPtr = new family("ARLENE", "Dusty", 1);
    //    familyPtr->addFriend("JERRY");
    //    ht.addFamily(0, familyPtr);
    //    delete familyPtr;
    //    familyPtr = new family("ARLENE", "Dusty", 1);
    ...
    //    ht.addFamily(0, familyPtr);
    //    delete familyPtr;
    //    familyPtr = new family("r", "D", 1);
    //    familyPtr->addFriend("JERRY");
    //    ht.addFamily(0, familyPtr);
    //    delete familyPtr;
    //    familyPtr = new family("z", "D", 1);
    //    familyPtr->addFriend("JERRY");
    //    ht.addFamily(0, familyPtr);
    //    delete familyPtr;
