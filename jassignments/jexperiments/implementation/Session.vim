...
badd +0 experiments.cpp
badd +0 plant.h
badd +0 plant.cpp
badd +0 ../expected.txt
badd +3 testplant.cpp
argglobal
silent! argdel *
$argadd instructions.txt
set stal=2
...
silent! normal! zE
let s:l = 39 - ((31 * winheight(0) + 26) / 52)
...
wincmd w
argglobal
if bufexists('testplant.cpp') | buffer testplant.cpp | else | edit testplant.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 84 - ((36 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
84
