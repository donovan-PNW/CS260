...
silent only
cd ~/jCS260/jassignments/jexperiments/implementation
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +4 experiments.cpp
badd +1 testtree.cpp
badd +1 instructions.txt
badd +26 planttree.h
badd +24 plant.h
badd +12 treenode.h
badd +1 planttree.cpp
badd +78 plant.cpp
badd +124 ../expected.txt
badd +0 makefile
argglobal
silent! argdel *
$argadd experiments.cpp
set stal=2
edit planttree.h
...
wincmd w
argglobal
if bufexists('experiments.cpp') | buffer experiments.cpp | else | edit experiments.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 71 - ((23 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
71
...
wincmd w
argglobal
if bufexists('plant.cpp') | buffer plant.cpp | else | edit plant.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 114 - ((60 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
114
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 22 - ((0 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
...
wincmd w
argglobal
if bufexists('testtree.cpp') | buffer testtree.cpp | else | edit testtree.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F9> :exec '!python3' shellescape(@%, 1)
let &cpo=s:cpo_save
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 10 - ((8 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 43 - ((25 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
...
wincmd w
argglobal
if bufexists('planttree.h') | buffer planttree.h | else | edit planttree.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 49 - ((18 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 74 - ((23 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
74
...
wincmd w
argglobal
if bufexists('treenode.h') | buffer treenode.h | else | edit treenode.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('plant.h') | buffer plant.h | else | edit plant.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 103 - ((19 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
103
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 23 - ((0 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
23
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 58 - ((27 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
58
