...
badd +0 planttree.h
badd +0 plant.cpp
badd +10 testplant.cpp
badd +1 testtree.
badd +0 testtree.cpp
badd +37 experiments.cpp
badd +36 ../expected.txt
badd +0 plant.h
argglobal
silent! argdel *
$argadd planttree.cpp
set stal=2
edit planttree.h
...
exe 'vert 1resize ' . ((&columns * 93 + 106) / 212)
exe 'vert 2resize ' . ((&columns * 118 + 106) / 212)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
if bufexists('planttree.cpp') | buffer planttree.cpp | else | edit planttree.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
...
106
normal! zo
let s:l = 243 - ((27 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
243
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 39 - ((35 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
