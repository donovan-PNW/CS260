...
silent only
cd ~/jCS260/jassignments/jexperiments/examplefiles/jbinarySearchTree.ptrArgs
...
silent! normal! zE
let s:l = 78 - ((51 * winheight(0) + 26) / 52)
...
wincmd w
argglobal
if bufexists('bst.cpp') | buffer bst.cpp | else | edit bst.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
