...
silent only
cd ~/jCS260/examples/linkedListADT
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 182 - ((15 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
182
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 102 - ((26 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
102
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 45 - ((26 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
...
wincmd w
argglobal
if bufexists('list.h') | buffer list.h | else | edit list.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 103 - ((50 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
103
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 155 - ((51 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
155
