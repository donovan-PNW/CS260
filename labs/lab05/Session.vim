...
silent! normal! zE
let s:l = 44 - ((41 * winheight(0) + 26) / 52)
...
wincmd w
argglobal
if bufexists('readme') | buffer readme | else | edit readme | endif
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 95 - ((49 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
95
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 100 - ((50 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
100
