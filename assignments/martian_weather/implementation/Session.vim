...
badd +407 datalogger.cpp
badd +61 weatherdata.cpp
badd +106 linkedlist.cpp
badd +6 datalogger.h
badd +1 weatherdata.h
badd +47 linkedlist.h
badd +1 linkedlist.
...
exe 'vert 1resize ' . ((&columns * 68 + 106) / 212)
exe 'vert 2resize ' . ((&columns * 1 + 106) / 212)
exe 'vert 3resize ' . ((&columns * 141 + 106) / 212)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 46 - ((0 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
