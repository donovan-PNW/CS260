...
set shortmess=aoO
badd +35 weatherlog.cpp
badd +26 datalogger.cpp
badd +61 weatherdata.cpp
badd +240 linkedlist.cpp
badd +24 datalogger.h
badd +1 weatherdata.h
badd +31 linkedlist.h
badd +1 linkedlist.
badd +1 datalogger.cpp\ linkedlist.cpp
badd +19 workingtowards.txt
argglobal
silent! argdel *
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 478 - ((47 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
478
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 480 - ((35 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
480
...
65
normal! zo
let s:l = 244 - ((26 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
244
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 75 - ((23 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
75
...
wincmd w
argglobal
if bufexists('weatherdata.cpp') | buffer weatherdata.cpp | else | edit weatherdata.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F9> :exec '!python3' shellescape(@%, 1)
let &cpo=s:cpo_save
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 370 - ((38 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
370
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 53 - ((52 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
