...
silent only
cd ~/jCS260/assignments/martian_weather/implementation
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +38 weatherlog.cpp
badd +353 datalogger.cpp
badd +69 weatherdata.cpp
badd +101 linkedlist.cpp
badd +6 datalogger.h
badd +35 weatherdata.h
badd +30 linkedlist.h
badd +1 linkedlist.
badd +1 datalogger.cpp\ linkedlist.cpp
badd +0 workingtowards.txt
argglobal
silent! argdel *
$argadd weatherlog.cpp
set stal=2
edit weatherlog.cpp
...
exe 'vert 1resize ' . ((&columns * 70 + 52) / 105)
exe 'vert 2resize ' . ((&columns * 70 + 52) / 105)
exe 'vert 3resize ' . ((&columns * 70 + 52) / 105)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let s:l = 46 - ((24 * winheight(0) + 26) / 52)
...
wincmd w
argglobal
if bufexists('datalogger.cpp') | buffer datalogger.cpp | else | edit datalogger.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('datalogger.h') | buffer datalogger.h | else | edit datalogger.h | endif
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <F9> :exec '!python3' shellescape(@%, 1)
let &cpo=s:cpo_save
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 388 - ((18 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
388
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 61 - ((0 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
...
wincmd w
argglobal
if bufexists('weatherdata.h') | buffer weatherdata.h | else | edit weatherdata.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 406 - ((23 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
406
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 55 - ((39 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
...
66
normal! zo
let s:l = 106 - ((20 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
106
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 407 - ((24 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
407
...
wincmd w
argglobal
if bufexists('workingtowards.txt') | buffer workingtowards.txt | else | edit workingtowards.txt | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
