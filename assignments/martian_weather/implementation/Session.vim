...
badd +40 weatherdata.h
badd +34 datalogger.h
badd +17 datalogger.cpp
badd +30 weatherlog.cpp
badd +17 midnightnotes.txt
argglobal
silent! argdel *
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 14 - ((7 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
14
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 70 - ((19 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 34 - ((15 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
